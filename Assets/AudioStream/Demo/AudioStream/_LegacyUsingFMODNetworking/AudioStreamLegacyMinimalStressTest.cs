...
/// </summary>
// [ExecuteInEditMode]
public class AudioStreamLegacyMinimalStressTest : MonoBehaviour
{
    /// <summary>
    /// List of components created at the start from code
    /// </summary>
    List<AudioStream.AudioStreamLegacyMinimal> audioStreams = new List<AudioStream.AudioStreamLegacyMinimal>();
    ...
    IEnumerator Start()
    {
        ...
        {
            var go = new GameObject("AudioStreamLegacyMinimal#" + i);

            var @as = go.AddComponent<AudioStream.AudioStreamLegacyMinimal>();
    ...
    void OnGUI()
    {
        ...
        GUILayout.Label("Stress testing scene for the AudioStreamLegacyMinimal component", AudioStreamMainScene.guiStyleLabelNormal);
        GUILayout.Label(string.Format("{0} AudioStreamLegacyMinimal game objects are created at Start and are set to start streaming simultaneously the same url", this.audioStreams.Count), AudioStreamMainScene.guiStyleLabelNormal);
