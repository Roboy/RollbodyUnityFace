...
public class AudioStreamMinimalStressTest : MonoBehaviour
{
    ...
    void OnGUI()
    {
        ...
        GUILayout.Label("Stress testing scene for the AudioStreamMinimal component", AudioStreamMainScene.guiStyleLabelNormal);
        GUILayout.Label(string.Format("{0} AudioStreamMinimal game objects are created at Start and are set to start streaming simultaneously the same url", this.audioStreams.Count), AudioStreamMainScene.guiStyleLabelNormal);
